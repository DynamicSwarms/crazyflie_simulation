...
private: 
    ...
    void cmd_velocity_world_callback(const std::shared_ptr<crazyflie_interfaces::msg::VelocityWorld> msg);
...
private: 
    ...
    std::shared_ptr<rclcpp::Subscription<crazyflie_interfaces::msg::VelocityWorld>> m_cmd_velocity_world_sub;
